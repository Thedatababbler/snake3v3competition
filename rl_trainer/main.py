...
def main(args):
    ...
    obs_dim = 26#[2, 20, 10]#inchannel, width, height#26
    ...
    while episode < args.max_episodes:
        ...
        print('*****state******')
        print(state_to_training)
        #{1: [[6, 12], [8, 14], [0, 7], [6, 2], [3, 1]], 
        # 2: [[0, 2], [0, 3], [0, 4]], 
        #3: [[9, 16], [9, 15], [9, 14]], 
        # 4: [[5, 14], [5, 13], [5, 12]], 
        #5: [[2, 9], [3, 9], [4, 9]], 
        # 6: [[0, 16], [1, 16], [2, 16]], 
        #7: [[6, 0], [7, 0], [8, 0]], 'board_width': 20, 
        # 'board_height': 10,
        # 'last_direction': None, 'controlled_snake_index': 2}
        # ======================= feature engineering =======================
