...
from algo.mynetworks import Actor, Critic
...
class DDPG:
    ...
    def choose_action(self, obs, evaluation=False):
        ...
        #agent_size!!!
        return action#[action for _ in range(3)]
    ...
    def random_action(self):
        ...
        return np.random.uniform(low=0, high=1, size=(1, 3, self.act_dim))
    ...
    def update(self):
        ...
        state_batch = torch.Tensor(state_batch).reshape(self.batch_size, 2, 10, 20).to(self.device)
        ...
        next_state_batch = torch.Tensor(next_state_batch).reshape(self.batch_size, 2, 10, 20).to(self.device)
